    ...
    <div className='w-full bg-white'>
      ...
      <div className='header-top bg-[#caddff] md-lg:hidden'>
        ...
        <div className='hidden md-lg:block'>
            <div onClick={()=>setShowSidebar(true)} className={`fixed duration-200 transition-all ${showSidebar ? 'invisible' :'visible'} w-screen h-screen hidden md-lg:block bg-[rgba(0,0,0,0.5)] top-0 left-0`}>
                    ...
                    <div className='flex justify-start flex-col gap-6'>
                        ...
                        <ul className='flex  flex-col justify-start items-start gap-3 text-sm font-bold uppercase '>
                            ...
                            <div className='w-full flex justify-end md-lg:justify-start gap--3 items-center '>
                                ...
                                <div className='flex justify-end flex-col gap-2 ml-3'>
                                    <h2 className='text-sm font-medium text-slate-700'>123456789</h2>
                    ...
                    <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6 '>
                        ...
                        <div className='w-4/12 block md-lg:hidden pl-2 md-lg:w-full md-lg:pl-0 '>
                            <div className='w-full flex justify-end md-lg:justify-start gap--3 items-center '>
                                    ...
                                    <div className='flex justify-end flex-col gap-2 ml-3'>
                                        <h2 className='text-md font-medium text-slate-700'>(+91)-1234567890</h2>
