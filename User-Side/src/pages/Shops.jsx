...
import ShopProducts from '../components/products/ShopProducts.jsx';
...
const Shops = () => {
    ...
    return (
        ...
        <div className='flex justify-center items-start gap-4 md-lg:hidden'>
         ...
         <div>
           {
             totalProduct > perPage &&  <Pagination pageNumber={pageNumber} setPageNumber={setPageNumber} totalItem={totalProduct} perPage={perPage} showItem={Math.floor(totalProduct / perPage )} />
           }
         </div>
