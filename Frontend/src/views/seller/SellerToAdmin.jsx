...
import {  get_seller_message,  send_message_seller_admin, updateAdminMessage,messageClear } from '../../store/Reducers/chatReducer.js'
...
const SellerToAdmin = () => {
    ...
    <div className='w-full md:pl-4'>
        <div className='flex justify-between items-center'>
         ...
         <img className='w-[45px] h-[45px] border-green-500 border-2 max-w-[45px] p-[2px] rounded-full' src="Images/Profiles/user.png" alt="Seller60" />
...

                {
                    ...
                    <div ref={scrollRef} key={i} className='w-full flex justify-start items-center'>
                            <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                                <div>
                                    <img className='w-[38px] h-[38px] border-2 border-white rounded-full max-w-[38px] p-[3px]' src="Images/Profiles/user.png" alt="" />
                                </div>
