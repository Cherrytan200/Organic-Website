...
import {get_admin_message,get_sellers,send_message_seller_admin,messageClear,updateSellerMessage} from './../../store/Reducers/chatReducer.js';
                    ...
                    <div className="flex justify-between items-center">
                        {
                            sellerId && <div className="flex justify-start items-center gap-3">
                                <div className="relative">
                                    <img className="w-[45px] h-[45px] border-green-500 border-2 max-w-[45px] p-[2px] rounded-full" src={currentSeller?.image} alt="seller image"/>
                        ...
                        sellerId ?  seller_admin_message.map((m, i) => {
                                if (m.senderId === sellerId) {
                                    ...
                                    <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                                        <div>
                                            <img className='w-[38px] h-[38px] border-2 border-white rounded-full max-w-[38px] p-[3px]' src="/Images/Profiles/user.png" alt="ChatSeller143" />
                                        </div>
                                    ...
                                    return(
                                        <div key={i} ref={scrollRef} className='w-full flex justify-end items-center'>
                                            ...
                                            <div>
                                                <img className='w-[38px] h-[38px] border-2 border-white rounded-full max-w-[38px] p-[3px]' src="/Images/Profiles/admin.jpeg" alt="" />
                                            </div>
                                </div> 
                            </div>
                                    )
